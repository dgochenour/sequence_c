...
int publisher_main(int domainId, int sample_count)
{
    ...
    MyTypeDataWriter *MyType_writer = NULL;
    ...
    retcode = MyTypeTypeSupport_register_type(
    ...
    MyType_writer = MyTypeDataWriter_narrow(writer);
    if (MyType_writer == NULL) {
    ...
    instance = MyTypeTypeSupport_create_data_ex(DDS_BOOLEAN_TRUE);
    if (instance == NULL) {
        fprintf(stderr, "MyTypeTypeSupport_create_data error\n");
        publisher_shutdown(participant);
        return -1;
    }
    ...
    /*
    retcode = MyTypeDataWriter_unregister_instance(
    ...
    */
    /* Delete data sample */
    retcode = MyTypeTypeSupport_delete_data_ex(instance, DDS_BOOLEAN_TRUE);
    if (retcode != DDS_RETCODE_OK) {
        fprintf(stderr, "MyTypeTypeSupport_delete_data error %d\n", retcode);
    }
